...
public let goldGradient = LinearGradient(colors: [Color("GoldenOlive"), Color("MustardYellow"), Color.yellow], startPoint: UnitPoint(x: 0.0, y: 0.0), endPoint: UnitPoint(x: 0.0, y: 1.0))
